...
# MFD Win Registry documentation build configuration file, created by
...
htmlhelp_basename = "mfd_win_registry"
...
latex_documents = [
    (
        master_doc,
        "mfd_win_registry.tex",
        "MFD Win Registry Documentation",
        "author",
        "manual",
    ),
]
...
man_pages = [(master_doc, "mfd_win_registry", "MFD Win Registry Documentation", [author], 1)]
